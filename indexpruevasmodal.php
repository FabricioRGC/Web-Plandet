            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6" style="padding-left: 50px; padding-right: 50px; margin-bottom: 40px">
                    <div class="row gy-4">
                        ...
                        <div class="col-12 col-lg-6 d-flex align-items-center p-3 background-PLANDET" style="border: 5px solid #65A693; background-color: #F2F2F2;">
    ...
    <footer class="py-5 bg-dark text-white" id="Contacto">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center gap-3 my-3">
                <a href="https://www.facebook.com/PLANDETTRUJILLO/" target="_blank" style="border: 2px solid rgb(116, 126, 123); border-radius: 50%">
                    <img src="pictures/facebook.svg" alt="Facebook" class="social-icon">
                </a>
                <a href="https://instagram.com" target="_blank" style="border: 2px solid rgb(116, 126, 123); border-radius: 50%">
                    <img src="pictures/instagram.svg" alt="Instagram" class="social-icon">
                </a>
                <a href="https://www.youtube.com/@TitulacionPLANDET" target="_blank" style="border: 2px solid rgb(116, 126, 123); border-radius: 50%">
                    <img src="pictures/youtube.svg" alt="YouTube" class="social-icon">
                </a>
            </div>
