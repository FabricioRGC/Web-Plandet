                    ...
                    <div class="flip-container" id="card1">
                        <div class="flipper">
                            <div class="card front">
                                <div class="text-left">
                                    <img src="pictures/picture-carrusel0006.png" style="width: 100%;">
                                </div>
                                <div class="p-3">
                                    <div>
                ...
                <div class="col-12 col-lg-4 justify-content-center content-contain hidden slide-right2" style="height: 470px;">
                    <div class="flip-container" id="card2">
                        <div class="flipper">
                            <div class="card front">
                                <div class="text-left">
                                    <img src="pictures/picture-carrusel0007.png" style="width: 100%;">
                                </div>
                                <div class="p-3">
                                    <div >
                ...
                <div class="col-12 col-lg-4 justify-content-center content-contain hidden slide-right3" style="height: 470px;">
                    <div class="flip-container" id="card3">
                        <div class="flipper">
                            <div class="card front">
                                <div class="text-left">
                                    <img src="pictures/picture-carrusel0008.png" style="width: 100%;">
                                </div>
                                <div class="p-3">
                                    <div>
