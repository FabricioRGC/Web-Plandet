...
document.addEventListener("DOMContentLoaded", function () {
    // Seleccionamos todos los h5 y las imágenes asociadas
    const titles = document.querySelectorAll(".card");

    titles.forEach((title) => {
        const hoverEffect = title.parentElement.querySelector(".hover-effect"); // Busca la imagen dentro de la misma tarjeta
        ...
        if (hoverEffect) {
            ...
            title.addEventListener("mouseleave", function () {
                ...
                hoverEffect.style.visibility = "hidden";
            });
        }
    });
});
    ...
    <div class="container-xxl" style="height: auto; min-height: 500px;">
        <div class="text-center">
            <h2 class="pt-5 fw-bold">Subgerencia</h2>
            <p>(PLANDET)</p>
        </div>
        <div>
            <div class="row">
                <div class="col-12 col-lg-4 justify-content-center content-contain hidden slide-right1" style="height: 470px;">
                    <div class="flip-container" id="card1">
                        <div class="flipper">
                            <div class="card front">
                                <div class="text-left">
                                    <img src="pictures/picture-carrusel0009.png" style="width: 100%;">
                ...
                <div class="col-12 col-lg-4 justify-content-center content-contain hidden slide-right2" style="height: 470px;">
                    <div class="flip-container" id="card2">
                        <div class="flipper">
                            <div class="card front">
                                <div class="text-left">
                                    <img src="pictures/picture-carrusel0010.png" style="width: 100%;">
                                    <div class="hover-effect">
                ...
                <div class="col-12 col-lg-4 justify-content-center content-contain hidden slide-right3" style="height: 470px;">
                    <div class="flip-container" id="card3">
                        <div class="flipper">
                            <div class="card front">
                                <div class="text-left">
                                    <img src="pictures/picture-carrusel0011.png" style="width: 100%;">
                                    <div class="hover-effect">
...
<hr>
    ...
    <section id="dashboard">
        <div class="container-lg mt-2">
            <div class="row">
                <h2 class="fw-bold mb-4 text-center sidebar-container hidden slide-left" style="padding: 20px">CONOCE PLANDET</h2>
    ...
    <style>
        ...
        .card {
            min-height: 420px; /* Para que todas las caras tengan la misma altura */
            display: flex;
    ...
    <footer class="py-5 bg-dark text-white" id="Contacto">
        <div class="container text-center">
            <h4 class="mb-3">Contacto</h4>
            <p class="mb-1"><i class="fas fa-phone-alt"></i> Teléfono: (044) 244212</p>
            <p class="mb-1"><i class="fas fa-envelope"></i> Correo: <a href="mailto:plandet@gmail.com" class="text-white text-decoration-none">plandet@gmail.com</a></p>
            <p class="mb-3"><i class="fas fa-map-marker-alt"></i> Sede: Av. España 793, Trujillo 13001</p>

            <div class="d-flex justify-content-center gap-3 my-3">
                <a href="https://www.facebook.com/PLANDETTRUJILLO/" target="_blank">
                    <img src="csv/facebook-24.svg" alt="Facebook" class="social-icon">
                </a>
                <a href="https://instagram.com" target="_blank">
                    <img src="csv/instagram-48.svg" alt="Instagram" class="social-icon">
                </a>
                <a href="https://www.youtube.com/@TitulacionPLANDET" target="_blank">
                    <img src="csv/youtube-50.svg" alt="YouTube" class="social-icon">
                </a>
            </div>

            <p class="mt-4 small">© 2025 <b>PLANDET</b>. Todos los derechos reservados.</p>
        </div>
    </footer>
    <script>
        document.addEventListener("DOMContentLoaded", function () {
