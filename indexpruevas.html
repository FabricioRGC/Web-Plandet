            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6" style="padding-left: 60px; padding-right: 60px; margin-bottom: 40px">
                    <div class="row gy-4">
                        ...
                        <div class="col-12 col-lg-6 d-flex align-items-center p-3 background-PLANDET" style="border: 5px solid white; background-color: #F2F2F2;">
    ...
    <footer class="py-5 bg-light" id="Contacto">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center align-items-center">
                ...
                <a href="https://www.youtube.com/@TitulacionPLANDET" target="_blank" class="mx-2">
